...
Route::group(['middleware' => ['jwt.auth'], 'namespace' => 'api'], function() {
    ...
    Route::POST('call/qa_manger_call_feedback_list', [CallController::class, 'qa_manger_call_feedback_list']);
    ...
    /// QA manager 
    Route::POST('report/qa_active_call_report', [ReportController::class,'qa_active_call_report']);
    Route::POST('report/qa_call_report_history', [ReportController::class,'qa_call_report_history']);
  ...
  //tickets 
    ...
    // export report pdf / csv and alos send file to the email
    Route::POST('report/call_report_history_export', [ReportController::class,'call_report_history_export']);
    Route::POST('report/active_call_report_history_export', [ReportController::class,'active_call_report_history_export']);
    Route::POST('report/interpreter_user_report_export', [ReportController::class,'interpreter_user_report_export']);
    Route::POST('report/supervisor_user_report_export', [ReportController::class,'supervisor_user_report_export']);
    Route::POST('report/frequent_user_report_export', [ReportController::class,'frequent_user_report_export']);
});
